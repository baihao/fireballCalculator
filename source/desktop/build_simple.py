...
def main():
    ...
    cmd = [
        ...
        '--icon=icon/fireball_app_icon.ico',  # 应用图标
        '--add-data=icon/fireball_app_icon.ico:icon',  # 添加图标数据
        '--add-data=icon/fireball_app_icon.png:icon',  # 添加PNG图标
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            # 检查输出文件
            exe_path = Path("dist/FireballAnalysis")
            if exe_path.exists():
